...
function scriptEnqueue(){
    ...
    wp_enqueue_script('cdnjquery', 'https://apps.bdimg.com/libs/jquery/1.11.3/jquery.min.js', array(), '2.1.4', true);
    if (!is_home()) {
    ...
    if (cs_get_option('i_carousel_switcher') && is_home()) {
        wp_enqueue_style('owlcss', get_template_directory_uri().'/assets/css/owl.carousel.min.css', array(), '1.3.2', 'all');
    ...
    if (cs_get_option('i_function_fancybox_switcher') && !is_home()) {
        wp_enqueue_style('FancyboxCss', '//apps.bdimg.com/libs/fancybox/2.1.4/jquery.fancybox.min.css', array(), '2.1.4', 'all');
        wp_enqueue_script('FancyboxJs', 'https://apps.bdimg.com/libs/fancybox/2.1.4/jquery.fancybox.min.js', array(), '2.1.4', true);
    }
    if (cs_get_option("i_site_language_switcher")) {
        wp_enqueue_script('languageJs', get_template_directory_uri().'/assets/js/zh-cn-tw.js', array(), '2.1.6', true);
    }
 ...
 * category image
 */
include('inc/vendor/category-image.php');
